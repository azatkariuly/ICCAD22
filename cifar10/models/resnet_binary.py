...
def Binaryconv3x3(in_planes, out_planes, stride=1, nbits_acc=8, T=64, SA=False, k=2, s=2):
    "3x3 convolution with padding"
    return BinarizeConv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                          padding=1, bias=False, nbits_acc=nbits_acc, T=T, SA=SA, k=k, s=s)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, do_bntan=True,
                 nbits_acc=8, T=64, SA=False, k=2, s=2):
...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10,
                 block=BasicBlock, depth=18, nbits_acc=8, T=64, SA=False, k=2, s=2):
...
def resnet18_binary(**kwargs):
    ...
    return ResNet_cifar10(num_classes=num_classes, block=BasicBlock, depth=depth,
                          T=kwargs['T'], SA=kwargs['SA'], nbits_acc=kwargs['nbits_acc'],
